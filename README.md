...
<div align="center">
  <a href="http://nestjs.com/" target="blank"><img src="https://raw.githubusercontent.com/docker/compose/v2/logo.png" alt="Docker Compose Logo" /></a>
...
``cd docker-scrips/ && ./restart.sh``

Stop:

``cd docker-scrips/ && ./stop.sh``
...
``cd docker-scrips/ && ./prod_build.sh``

Restart container:

``cd docker-scrips/ && ./prod_restart.sh``

Stop:

``cd docker-scrips/ && ./prod_stop.sh``
